...
{
    public class EnigmaRing : ModProjectile
	{
		...
		public override void AI()
        {
            ...
            for (int num729 = 0; num729 < 1; num729++)
            {
                ...
                float num732 = 0.5f;
                int num733 = Dust.NewDust(projectile.position, projectile.width, projectile.height, DustID.Electric, 0f, 0f, 100, default, 0.5f);
                ...
                {
                    num733 = Dust.NewDust(projectile.position, projectile.width, projectile.height, DustID.Electric, 0f, 0f, 100, default, 0.9f);
                    Main.dust[num733].noGravity = true;
                ...
                {
                    num733 = Dust.NewDust(projectile.position, projectile.width, projectile.height, DustID.Electric, 0f, 0f, 100, default, 0.7f);
                    Main.dust[num733].noGravity = true;
                    Main.dust[num733].velocity *= 1.2f;
                    Main.dust[num733].position = ((float)Main.rand.NextDouble() * 6.28318548f).ToRotationVector2() * (num731 + num732 * (float)Main.rand.NextDouble() * num730) + projectile.Center;
                    Main.dust[num733].velocity = Main.dust[num733].velocity / 2f + Vector2.Normalize(Main.dust[num733].position - projectile.Center);
