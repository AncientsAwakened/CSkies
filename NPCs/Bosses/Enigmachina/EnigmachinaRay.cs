...
namespace CSkies.NPCs.Bosses.Enigmachina
{
    public class EnigmachinaRay : ModProjectile
    {
        private const float maxTime = 90;

        public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Enigmatic Deathray");
		}
        ...
        public override void AI()
        {
            ...
            if (Main.npc[ai1].active && Main.npc[ai1].type == mod.NPCType("Enigmachina"))
            {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D texture2D20 = mod.GetTexture("CSkies/NPCs/Bosses/Enigmachina/EnigmachinaRay2");
            Texture2D texture2D21 = mod.GetTexture("CSkies/NPCs/Bosses/Enigmachina/EnigmachinaRay3");
        ...
        {
            target.AddBuff(mod.BuffType("Starfire"), 5400);
        }
    }
}