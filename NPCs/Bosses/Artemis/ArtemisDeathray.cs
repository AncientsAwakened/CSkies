...
namespace CSkies.NPCs.Bosses.Artemis
{
    public class ArtemisDeathray : ModProjectile
    {
        private const float maxTime = 90;

        public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Luminoth Deathray");
		}
        ...
        public override void AI()
        {
            ...
            if (Main.npc[ai1].active && Main.npc[ai1].type == mod.NPCType("ArtemisLuminoth"))
            {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D texture2D20 = mod.GetTexture("CSkies/NPCs/Bosses/Artemis/ArtemisDeathray2");
            Texture2D texture2D21 = mod.GetTexture("CSkies/NPCs/Bosses/Artemis/ArtemisDeathray3");
